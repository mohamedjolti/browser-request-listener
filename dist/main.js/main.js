...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   BrowserRequestController: () => (/* binding */ BrowserRequestController),\n/* harmony export */   setIsAlredyApplied: () => (/* binding */ setIsAlredyApplied)\n/* harmony export */ });\n/* harmony import */ var _Sender__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Sender */ \"./src/Sender.js\");\n/* harmony import */ var _applyForFetchApi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./applyForFetchApi */ \"./src/applyForFetchApi.js\");\n/* harmony import */ var _applyForXmlHttpRequest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./applyForXmlHttpRequest */ \"./src/applyForXmlHttpRequest.js\");\n/* harmony import */ var _defaultReport__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./defaultReport */ \"./src/defaultReport.js\");\n/* harmony import */ var _messages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./messages */ \"./src/messages.js\");\n/* harmony import */ var _postSubscribers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./postSubscribers */ \"./src/postSubscribers.js\");\n/* harmony import */ var _preSubscribers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./preSubscribers */ \"./src/preSubscribers.js\");\n\n\n\n\n\n\n\n\n\n\n/**\n* @var {boolean} isAlredyApplied the change of native function should be singelton\n*/\nlet isAlredyApplied = false;\n\n\nconst setIsAlredyApplied = function(status){\n  isAlredyApplied = status;\n}\n\nclass BrowserRequestController {\n\n    /**\n     * @param {JSON} configuration\n     */\n    constructor(configuration) {\n        this.configuration = configuration;\n\n    }\n\n    /**\n     * @param {function} callBack\n     * \n     */\n    callbackPreHttpRequest(callBack) {\n        (0,_preSubscribers__WEBPACK_IMPORTED_MODULE_6__.addNewPreSubscriber)(callBack);\n    }\n\n    /**\n    * @param {function} callBack\n    */\n    callbackPostHttpRequest(callBack) {\n        (0,_postSubscribers__WEBPACK_IMPORTED_MODULE_5__.addNewPostSubscriber)(callBack)\n    }\n\n    async apply() {\n        if (!isAlredyApplied) {\n            if (!this.configuration.filters.disabelForFetchApi) {\n                (0,_applyForFetchApi__WEBPACK_IMPORTED_MODULE_1__.applyForFetchAPi)(this.configuration);\n            }\n            if (!this.configuration.filters.disabelForXhr) {\n                (0,_applyForXmlHttpRequest__WEBPACK_IMPORTED_MODULE_2__.applyForXMlHttpRequest)(this.configuration);\n            }\n        } else {\n            throw new console.warn(_messages__WEBPACK_IMPORTED_MODULE_4__.CXTR_ERROR_APPLY_CALLED_MORE_THAN_ONCE);\n        }\n    }\n\n\n}\n\n\n//# sourceURL=webpack://control-xml-http-request/./src/browserRequestController.js?");
...
/***/ "./tests/calls/postXhrExistFailed.js":
/*!*******************************************!*\
  !*** ./tests/calls/postXhrExistFailed.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   postXhrExistFaildUrlNotFound: () => (/* binding */ postXhrExistFaildUrlNotFound)\n/* harmony export */ });\nconst postXhrExistFaildUrlNotFound = function () {\n    const apiUrl = 'https://jsonplaceholder.typicode.com/errorxhr';\n\n    const data = JSON.stringify({\n        title: 'foo',\n        body: 'bar',\n        userId: 1\n    });\n    const xhr = new XMLHttpRequest();\n    xhr.onload = () => {\n        if (xhr.status === 201) {\n            const post = JSON.parse(xhr.responseText);\n            console.log(post);\n        } else {\n            console.log('Server response:', xhr.status);\n        }\n    };\n    xhr.onerror = () => {\n        console.log('An error occurred, not able to process the request.');\n    };\n    xhr.open('POST', apiUrl, true);\n    xhr.setRequestHeader('Content-Type', 'application/json');\n    xhr.send(data);\n}\n\n//# sourceURL=webpack://control-xml-http-request/./tests/calls/postXhrExistFailed.js?");
