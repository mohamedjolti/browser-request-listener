...
/***/ "./tests/calls/postXhrSuccess.js":
/*!***************************************!*\
  !*** ./tests/calls/postXhrSuccess.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   postXhrSuccess: () => (/* binding */ postXhrSuccess)\n/* harmony export */ });\n\nconst postXhrSuccess = function () {\n    return new Promise(function(resolve){\n        const apiUrl = 'https://jsonplaceholder.typicode.com/posts';\n\n        const data = JSON.stringify({\n            title: 'foo',\n            body: 'bar',\n            userId: 1\n        });\n        const xhr = new XMLHttpRequest();\n        xhr.addEventListener(\"readystatechange\", function () {\n            if (this.readyState == 4) {\n                resolve(JSON.parse(this.response))\n            }\n        })\n        xhr.onerror = () => {\n            console.log('An error occurred, not able to process the request.');\n        };\n        xhr.open('POST', apiUrl, true);\n        xhr.setRequestHeader('Content-Type', 'application/json');\n        xhr.send(data);\n    })\n}\n\n//# sourceURL=webpack://control-xml-http-request/./tests/calls/postXhrSuccess.js?");
